...
use Cline\Data\Casts\FloorCast;
use Spatie\LaravelData\Data;

describe('FloorCast', function (): void {
    describe('Happy Paths', function (): void {
        test('casts float to floor', function (): void {
        ...
        test('casts negative float to floor', function (): void {
            $dataClass = new class() extends Data
            {
                public function __construct(
                    #[FloorCast()]
    ...
    describe('Edge Cases', function (): void {
        ...
        test('handles very small decimal values', function (): void {
            ...
            $data = $dataClass::from(['field' => 0.999_9]);
        ...
        test('handles large values', function (): void {
            ...
            $data = $dataClass::from(['field' => 999_999.9]);

            expect($data->field)->toBe(999_999.0);
        });
    });
});
