...
/**
 * Validates that a field is present (key exists in input) when another field equals a value.
 *
 * This attribute ensures the field key exists in the input data when another
...
final class PresentIf extends StringValidationAttribute implements RequiringRule
{
    ...
    /**
     * Create a new present_if validation attribute instance.
     *
     ...
     *                                                                                               values, this field must be present in the input.
     ...
     *
     * @return string The validation rule keyword 'present_if'
     */
    #[Override()]
